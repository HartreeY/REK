...
using Serialization
procid = myid()-1
#serialize("../data/3d_radial/gridrefl3_$procid-world.dat",world)
serialize("../data/3d_radial/gridrefl3_$procid-pop.dat",populations)
serialize("../data/3d_radial/gridrefl3_$procid-meanf.dat",meanf_world)